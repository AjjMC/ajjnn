...
execute if score #row_count ajjnn < #column_count ajjnn if score #count ajjnn matches 0 run schedule function ajjnn:nn/math/transform_vector_elements 1t
execute if score #row_count ajjnn < #column_count ajjnn unless score #count ajjnn matches 0 run function ajjnn:nn/math/transform_vector_elements