execute if score #layer_count ajjnn matches 0 run data modify storage ajjnn:math u set from storage ajjnn:nn input
...
execute if data storage ajjnn:temp layer.weights unless score #input_rows ajjnn = #columns ajjnn run tellraw @s [{"text":"Mismatch at layer ","color":"red"},{"score":{"name":"#layer_count","objective":"ajjnn"}},{"text":"; "},{"score":{"name":"#input_rows","objective":"ajjnn"}},{"text":" != "},{"score":{"name":"#columns","objective":"ajjnn"}}]
execute if data storage ajjnn:temp layer.weights unless score #input_rows ajjnn = #columns ajjnn run function ajjnn:nn/layers/finish
execute if data storage ajjnn:nn {status:0b} run return fail
...
execute if score #layer_count ajjnn = #sequence_length ajjnn run data modify storage ajjnn:nn output set from storage ajjnn:math y
execute if score #layer_count ajjnn = #sequence_length ajjnn run data modify storage ajjnn:nn status set value 2b
execute if score #layer_count ajjnn = #sequence_length ajjnn run schedule function ajjnn:nn/layers/finish 1t

execute if score #layer_count ajjnn < #sequence_length ajjnn run function ajjnn:nn/layers/next with storage ajjnn:temp argument