data modify storage ajjnn:temp layer set from storage ajjnn:nn sequence[0]
...
data modify storage ajjnn:nn sequence append from storage ajjnn:nn sequence[0]
data remove storage ajjnn:nn sequence[0]
