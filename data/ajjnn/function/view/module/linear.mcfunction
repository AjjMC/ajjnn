...
tellraw @s [{score:{name:"#modules_count",objective:"ajjnn"}},{text:". "},{storage:"ajjnn:data",nbt:"temp.module_name",interpret:true,color:"red"},{text:" Module ("},{score:{name:"#rows_length",objective:"ajjnn"}},{text:"x"},{score:{name:"#columns_length",objective:"ajjnn"}},{text:")"}]